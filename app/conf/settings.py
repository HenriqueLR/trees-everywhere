...
SECRET_KEY = 'django-insecure-frw05hz8l2$w$bf4z@dj^*nq(&4=mnr^lga%5#@svq!t3!(hdy'
...
STATIC_ROOT = os.path.join(BASE_DIR,'interface/static_files')
...
LOGIN_REDIRECT_URL = 'trees:list_plants'
